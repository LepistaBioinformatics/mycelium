...
- *(beginners)* Accept internal tokens on REST account creation
...
- *(hmac-rotation)* [**breaking**] KVR versioned signing — BREAKING (Etapa 3)

### 🐛 Bug Fixes

- *(telegram)* Link identity to personal account, not subscription account
- Resolve RUSTSEC advisories and format violations
...
- Remove rust-mcp-sdk from the project
