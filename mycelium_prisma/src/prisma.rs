...
pub mod user {
    ...
    pub mod accounts {
        ...
        pub fn is(value: Vec<account::WhereParam>) -> WhereParam {
            WhereParam::AccountsIs(value)
        }
        pub fn is_not(value: Vec<account::WhereParam>) -> WhereParam {
            WhereParam::AccountsIsNot(value)
        }
    ...
    pub struct Data {
        ...
        pub accounts: Option<Option<Box<super::account::Data>>>,
    }
    impl Data {
        pub fn accounts(
            &self,
    ...
    #[derive(Clone)]
    pub enum WithParam {
        Accounts(super::account::UniqueArgs),
    }
    ...
    pub enum SetParam {
        ...
        ConnectAccounts(super::account::UniqueWhereParam),
        DisconnectAccounts,
    }
    impl Into<(String, ::prisma_client_rust::PrismaValue)> for SetParam {
        fn into(self) -> (String, ::prisma_client_rust::PrismaValue) {
            match self { SetParam :: SetId (value) => ("id" . to_string () , :: prisma_client_rust :: PrismaValue :: String (value)) , SetParam :: SetUsername (value) => ("username" . to_string () , :: prisma_client_rust :: PrismaValue :: String (value)) , SetParam :: SetEmail (value) => ("email" . to_string () , :: prisma_client_rust :: PrismaValue :: String (value)) , SetParam :: SetFirstName (value) => ("first_name" . to_string () , :: prisma_client_rust :: PrismaValue :: String (value)) , SetParam :: SetLastName (value) => ("last_name" . to_string () , :: prisma_client_rust :: PrismaValue :: String (value)) , SetParam :: SetCreated (value) => ("created" . to_string () , :: prisma_client_rust :: PrismaValue :: DateTime (value)) , SetParam :: SetUpdated (value) => ("updated" . to_string () , value . map (| value | :: prisma_client_rust :: PrismaValue :: DateTime (value)) . unwrap_or (:: prisma_client_rust :: PrismaValue :: Null)) , SetParam :: ConnectAccounts (where_param) => ("accounts" . to_string () , :: prisma_client_rust :: PrismaValue :: Object (vec ! [("connect" . to_string () , :: prisma_client_rust :: PrismaValue :: Object ([where_param] . into_iter () . map (Into :: < super :: account :: WhereParam > :: into) . map (:: prisma_client_rust :: WhereInput :: serialize) . map (:: prisma_client_rust :: SerializedWhereInput :: transform_equals) . collect ()))])) , SetParam :: DisconnectAccounts => ("accounts" . to_string () , :: prisma_client_rust :: PrismaValue :: Object (vec ! [("disconnect" . to_string () , :: prisma_client_rust :: PrismaValue :: Boolean (true))])) }
        }
    }
    #[derive(Clone)]
