...
pub async fn delete_tenant(
    ...
    let result = tenant_deletion_repo.delete(tenant_id).await;
    ...
    emit_resource_audit_event(
        ...
        serde_json::json!({ "action": "delete_tenant" }),
    )
    .await;
...
mod tests {
    ...
    #[tokio::test]
    async fn delete_tenant_emits_audit_event_on_success() {
    ...
    #[tokio::test]
    async fn delete_tenant_does_not_emit_audit_event_on_permission_error() {
