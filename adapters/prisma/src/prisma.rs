...
pub mod error_code {
    ...
    pub mod code {
        ...
        pub fn in_vec(value: Vec<i32>) -> WhereParam {
            WhereParam::Code(_prisma::read_filters::IntFilter::InVec(value))
        }
        pub fn not_in_vec(value: Vec<i32>) -> WhereParam {
            WhereParam::Code(_prisma::read_filters::IntFilter::NotInVec(value))
        }
        pub fn lt(value: i32) -> WhereParam {
            WhereParam::Code(_prisma::read_filters::IntFilter::Lt(value))
        }
        pub fn lte(value: i32) -> WhereParam {
            WhereParam::Code(_prisma::read_filters::IntFilter::Lte(value))
        }
        pub fn gt(value: i32) -> WhereParam {
            WhereParam::Code(_prisma::read_filters::IntFilter::Gt(value))
        }
        pub fn gte(value: i32) -> WhereParam {
            WhereParam::Code(_prisma::read_filters::IntFilter::Gte(value))
        }
        pub fn not(value: i32) -> WhereParam {
            WhereParam::Code(_prisma::read_filters::IntFilter::Not(value))
        }
    ...
    pub mod prefix {
        ...
        pub fn in_vec(value: Vec<String>) -> WhereParam {
            WhereParam::Prefix(_prisma::read_filters::StringFilter::InVec(
                value,
            ))
        }
        pub fn not_in_vec(value: Vec<String>) -> WhereParam {
            WhereParam::Prefix(_prisma::read_filters::StringFilter::NotInVec(
                value,
            ))
        }
        pub fn lt(value: String) -> WhereParam {
            WhereParam::Prefix(_prisma::read_filters::StringFilter::Lt(value))
        }
        pub fn lte(value: String) -> WhereParam {
            WhereParam::Prefix(_prisma::read_filters::StringFilter::Lte(value))
        }
        pub fn gt(value: String) -> WhereParam {
            WhereParam::Prefix(_prisma::read_filters::StringFilter::Gt(value))
        }
        pub fn gte(value: String) -> WhereParam {
            WhereParam::Prefix(_prisma::read_filters::StringFilter::Gte(value))
        }
        pub fn contains(value: String) -> WhereParam {
            WhereParam::Prefix(_prisma::read_filters::StringFilter::Contains(
                value,
            ))
        }
        pub fn starts_with(value: String) -> WhereParam {
            WhereParam::Prefix(_prisma::read_filters::StringFilter::StartsWith(
                value,
            ))
        }
        pub fn ends_with(value: String) -> WhereParam {
            WhereParam::Prefix(_prisma::read_filters::StringFilter::EndsWith(
                value,
            ))
        }
        pub fn mode(value: QueryMode) -> WhereParam {
            WhereParam::Prefix(_prisma::read_filters::StringFilter::Mode(value))
        }
        pub fn not(value: String) -> WhereParam {
            WhereParam::Prefix(_prisma::read_filters::StringFilter::Not(value))
        }
        pub struct Include;
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
    ...
    pub mod message {
        ...
        pub fn in_vec(value: Vec<String>) -> WhereParam {
            WhereParam::Message(_prisma::read_filters::StringFilter::InVec(
                value,
            ))
        }
        pub fn not_in_vec(value: Vec<String>) -> WhereParam {
            WhereParam::Message(_prisma::read_filters::StringFilter::NotInVec(
                value,
            ))
        }
        pub fn lt(value: String) -> WhereParam {
        ...
        pub fn contains(value: String) -> WhereParam {
            WhereParam::Message(_prisma::read_filters::StringFilter::Contains(
                value,
            ))
        }
        pub fn starts_with(value: String) -> WhereParam {
        ...
        pub fn ends_with(value: String) -> WhereParam {
            WhereParam::Message(_prisma::read_filters::StringFilter::EndsWith(
                value,
            ))
        }
        pub fn mode(value: QueryMode) -> WhereParam {
            WhereParam::Message(_prisma::read_filters::StringFilter::Mode(
                value,
            ))
        }
        pub fn not(value: String) -> WhereParam {
    ...
    pub mod is_internal {
        ...
        pub fn not(value: bool) -> WhereParam {
            WhereParam::IsInternal(_prisma::read_filters::BoolFilter::Not(
                value,
            ))
        }
        pub struct Include;
        ...
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
                ::prisma_client_rust::sel("is_internal")
            }
        }
        pub struct Select;
        impl Into<super::SelectParam> for Select {
    ...
    #[macro_export]
    macro_rules ! _select_error_code { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { $ crate :: prisma :: error_code :: select ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: SelectType for Selection { type Data = Data ; type ModelData = $ crate :: prisma :: error_code :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn select ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([$ crate :: prisma :: error_code :: select ! (@ selections_to_params ; : select { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () ,] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { $ crate :: prisma :: error_code :: select ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: SelectType for Selection { type Data = Data ; type ModelData = $ crate :: prisma :: error_code :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([$ crate :: prisma :: error_code :: select ! (@ selections_to_params ; : select { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () ,] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { code , prefix , message , details , is_internal } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { $ (pub $ field : $ crate :: prisma :: error_code :: select ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) +] . len ()) ? ; $ (state . serialize_field ($ crate :: prisma :: error_code :: select ! (@ field_serde_name ; $ field) , & self . $ field) ? ;) * state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (concat ! ($ ($ crate :: prisma :: error_code :: select ! (@ field_serde_name ; $ field) , ", ") , + ,)) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ ($ crate :: prisma :: error_code :: select ! (@ field_serde_name ; $ field) => Ok (Field :: $ field)) , * , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * while let Some (key) = map . next_key () ? { match key { $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: error_code :: select ! (@ field_serde_name ; $ field))) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: error_code :: select ! (@ field_serde_name ; $ field))) ? ;) * Ok (Data { $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["code" , "prefix" , "message" , "details" , "is_internal"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { $ crate :: prisma :: error_code :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; code) => { i32 } ; (@ field_type ; prefix) => { String } ; (@ field_type ; message) => { String } ; (@ field_type ; details) => { Option < String > } ; (@ field_type ; is_internal) => { bool } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "ErrorCode" , available relations are "code, prefix, message, details, is_internal")) } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; code) => { Into :: < $ crate :: prisma :: error_code :: SelectParam > :: into ($ crate :: prisma :: error_code :: code :: Select) } ; (@ selection_field_to_selection_param ; prefix) => { Into :: < $ crate :: prisma :: error_code :: SelectParam > :: into ($ crate :: prisma :: error_code :: prefix :: Select) } ; (@ selection_field_to_selection_param ; message) => { Into :: < $ crate :: prisma :: error_code :: SelectParam > :: into ($ crate :: prisma :: error_code :: message :: Select) } ; (@ selection_field_to_selection_param ; details) => { Into :: < $ crate :: prisma :: error_code :: SelectParam > :: into ($ crate :: prisma :: error_code :: details :: Select) } ; (@ selection_field_to_selection_param ; is_internal) => { Into :: < $ crate :: prisma :: error_code :: SelectParam > :: into ($ crate :: prisma :: error_code :: is_internal :: Select) } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ ($ crate :: prisma :: error_code :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; code) => { "code" } ; (@ field_serde_name ; prefix) => { "prefix" } ; (@ field_serde_name ; message) => { "message" } ; (@ field_serde_name ; details) => { "details" } ; (@ field_serde_name ; is_internal) => { "is_internal" } ; }
    ...
    #[macro_export]
    macro_rules ! _include_error_code { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { $ crate :: prisma :: error_code :: include ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = $ crate :: prisma :: error_code :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn include ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([$ crate :: prisma :: error_code :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < $ crate :: prisma :: error_code :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { $ crate :: prisma :: error_code :: include ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = $ crate :: prisma :: error_code :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([$ crate :: prisma :: error_code :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < $ crate :: prisma :: error_code :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { pub code : i32 , pub prefix : String , pub message : String , pub details : Option < String > , pub is_internal : bool , $ (pub $ field : $ crate :: prisma :: error_code :: include ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) + stringify ! (code) , stringify ! (prefix) , stringify ! (message) , stringify ! (details) , stringify ! (is_internal)] . len ()) ? ; $ (state . serialize_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; $ field) , & self . $ field) ? ;) * state . serialize_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; code) , & self . code) ? ; state . serialize_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; prefix) , & self . prefix) ? ; state . serialize_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; message) , & self . message) ? ; state . serialize_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; details) , & self . details) ? ; state . serialize_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; is_internal) , & self . is_internal) ? ; state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , code , prefix , message , details , is_internal } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (concat ! ($ ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; $ field) , ", ") , + , $ crate :: prisma :: error_code :: include ! (@ field_serde_name ; code) , ", " , $ crate :: prisma :: error_code :: include ! (@ field_serde_name ; prefix) , ", " , $ crate :: prisma :: error_code :: include ! (@ field_serde_name ; message) , ", " , $ crate :: prisma :: error_code :: include ! (@ field_serde_name ; details) , ", " , $ crate :: prisma :: error_code :: include ! (@ field_serde_name ; is_internal) , ", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; $ field) => Ok (Field :: $ field)) , * , $ crate :: prisma :: error_code :: include ! (@ field_serde_name ; code) => Ok (Field :: code) , $ crate :: prisma :: error_code :: include ! (@ field_serde_name ; prefix) => Ok (Field :: prefix) , $ crate :: prisma :: error_code :: include ! (@ field_serde_name ; message) => Ok (Field :: message) , $ crate :: prisma :: error_code :: include ! (@ field_serde_name ; details) => Ok (Field :: details) , $ crate :: prisma :: error_code :: include ! (@ field_serde_name ; is_internal) => Ok (Field :: is_internal) , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * let mut code = None ; let mut prefix = None ; let mut message = None ; let mut details = None ; let mut is_internal = None ; while let Some (key) = map . next_key () ? { match key { Field :: code => { if code . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; code))) ; } code = Some (map . next_value () ?) ; } Field :: prefix => { if prefix . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; prefix))) ; } prefix = Some (map . next_value () ?) ; } Field :: message => { if message . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; message))) ; } message = Some (map . next_value () ?) ; } Field :: details => { if details . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; details))) ; } details = Some (map . next_value () ?) ; } Field :: is_internal => { if is_internal . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; is_internal))) ; } is_internal = Some (map . next_value () ?) ; } $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; $ field))) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; $ field))) ? ;) * let code = code . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; code))) ? ; let prefix = prefix . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; prefix))) ? ; let message = message . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; message))) ? ; let details = details . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; details))) ? ; let is_internal = is_internal . ok_or_else (|| serde :: de :: Error :: missing_field ($ crate :: prisma :: error_code :: include ! (@ field_serde_name ; is_internal))) ? ; Ok (Data { code , prefix , message , details , is_internal , $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["code" , "prefix" , "message" , "details" , "is_internal"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { $ crate :: prisma :: error_code :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "ErrorCode" , available relations are "")) } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ ($ crate :: prisma :: error_code :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; code) => { "code" } ; (@ field_serde_name ; prefix) => { "prefix" } ; (@ field_serde_name ; message) => { "message" } ; (@ field_serde_name ; details) => { "details" } ; (@ field_serde_name ; is_internal) => { "is_internal" } ; }
    ...
    impl ::prisma_client_rust::WhereInput for WhereParam {
        fn serialize(self) -> ::prisma_client_rust::SerializedWhereInput {
            let (name, value) = match self {
                ...
                Self::Prefix(value) => ("prefix", value.into()),
                Self::Message(value) => ("message", value.into()),
                Self::Details(value) => ("details", value.into()),
                Self::IsInternal(value) => ("is_internal", value.into()),
            };
            ::prisma_client_rust::SerializedWhereInput::new(name, value.into())
        }
    }
    ...
    impl ::prisma_client_rust::ModelTypes for Types {
        ...
        type OrderBy = OrderByParam;
        type Cursor = UniqueWhereParam;
        const MODEL: &'static str = "ErrorCode";
        fn scalar_selections() -> Vec<::prisma_client_rust::Selection> {
            ["code", "prefix", "message", "details", "is_internal"]
                .into_iter()
                .map(::prisma_client_rust::sel)
                .collect()
        }
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create(
            ...
            _params.push(prefix::set(prefix));
