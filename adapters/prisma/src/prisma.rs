...
pub mod user {
    ...
    pub fn create(
        ...
        (username, email, first_name, last_name, account, _params)
    }
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (username, email, first_name, last_name, account, mut _params): (
                String,
                String,
                String,
                String,
